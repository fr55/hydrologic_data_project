...
1. What are the predictors of nutrients in multiple watersheds within New York State?

2. How have these predictors changed over time? 

3. How are these predictors different between sites?
...
1a. Higher proportions of natural (forested and grassland) land use will be positively correlated  water quality due to higher rates of nutrient uptake in plants and lower outputs of nutrients in runoff.
...
1c. Higher amounts of atmospheric depoisition will positively correlated with water quality due to increased  precipitation and dryfall into watersheds.
